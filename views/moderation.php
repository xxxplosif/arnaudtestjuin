...
echo '<p>'.pagination(getCountPhoto()['nb'],$pos,20,"page=moderation&pos").'</p>';
...
<div class="mini">
    ...
    <a href="./?page=moderation&action=edit&id=<?php echo $liste_photos[$i]['id']; ?>"><img src="./images/common/edit.png"/></a>
...
<form action="./?page=moderation&action=treatedit&id=<?php echo $photo['id']; ?>" method="POST">
